...
30 universal principles distilled from Kent Beck's _Smalltalk Best Practice Patterns_, generalized for any codebase.
...
Override toString / \_\_repr\_\_ / inspect to show the **structural** information a developer needs when debugging. User-facing display strings are a separate concern.
